# todo
- [ ] sched: memory passage recitation
- [ ] salvage all orphaned items in garage
- [ ] document all events from 2023_01_09
  - source
    - google maps navigation history
    - phone recent calls list
- [ ] send info to AAA Insurance
  - [ ] police report
  - [ ] bill of purchase for 2015 Toyota Prius
- [x] sched: amazon delivery
- [x] put $20 in the stress bank
