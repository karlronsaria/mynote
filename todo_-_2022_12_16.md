...
- neovim
  - [ ] test path under cursor
  - [ ] open registry to path under cursor
  - [ ] open powershell to parent path under cursor
  - [ ] open explorer to parent path under cursor
  - [ ] move cursor to child in folded node
- drag-and-drop cards
  - [ ] mockups
  - [ ] programmatic
  - [ ] visual style
